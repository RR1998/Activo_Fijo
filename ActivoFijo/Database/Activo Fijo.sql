...
ALTER TABLE ACTIVO_FIJO.BIEN
  ADD FOREIGN KEY (IDMARCA) REFERENCES ACTIVO_FIJO.MARCA (IDMARCA);
ALTER TABLE ACTIVO_FIJO.BIEN
  ADD FOREIGN KEY (IDTIPO) REFERENCES ACTIVO_FIJO.TIPO (IDTIPO);
ALTER TABLE ACTIVO_FIJO.BIEN
    ADD FOREIGN KEY (IDESTADO) REFERENCES ACTIVO_FIJO.ESTADO(IDEstado);

INSERT INTO ACTIVO_FIJO.USUARIO(USUARIO, CLAVE, Nombre, DUI) VALUES('CBRC Contabilidad', 'CBRC2019', 'Roxana', '00000000-1');
